...
import { FaShoppingCart ,FaWallet ,FaCalendar, FaHome ,FaStar, FaBookmark } from 'react-icons/fa';
...
const Dashboard = () => {
  ...
  return (
    ...
    <div className="drawer-side">
      ...
      <ul className="menu p-4 w-80 text-center text-2xl h-full bg-[#D1A054] text-base-content">
